...
tk.Button(text='0', bd=5, font=('Arial', 15),command=lambda : add_digit(0)).grid(row=4, column=0, stick='wens', padx=5, pady=5)
...
perc_button('%').grid(row=3, column=5, stick='wens', padx=5, pady=5)
